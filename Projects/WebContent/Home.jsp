...
<center><a href="javascript:login('hide'); " class="cancel" style="color:#0099FF;" >&times;</a></center> 
        ...
        <form action="register" method="post">
            <input type="text" id="textBox" name="email" placeholder="email id" style="background-color:white; color: black"/><br><br>
            <input type="text"id="textBox"name = "user"placeholder="user id"style="background-color:white; color: black"/><br><br>
            <input type="text"id="textBox"name = "pass"placeholder="password"style="background-color:white; color: black"/><br><br>
            <input type="text"id="textBox"placeholder="confirm password"style="background-color:white; color: black"/><br><br>
    ...
    border-bottom-right-radius: 5px; margin-top:-23px;box-shadow: 0px 0px 4px 0px #666;margin-right: -3px;">
            ...
            <input type="submit" value="Create Account" id="create" /></form>
        </div></center>
        </div>
...
<div id="button"> <a  href="javascript:login('show'); " style="float: left;    width: 44%;
    height: 36px;"></a>  
     <a  href="javascript:register('show'); "  style="float: right;    width: 44%;
    height: 36px;"></a> </div>
        <div id="site_title">
        ...
        <div id="tooplate_menu2" style="background: url(images/tooplate_menu.png) no-repeat;">
            ...
            <ul>
                ...
                <li><a href="postProjects.jsp" target="frame1" style="color: white; background-color: orangered; border-radius: 5px 5px;">Post Projects</a></li>
