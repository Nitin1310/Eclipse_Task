...
<div style="margin-left: 12%; padding-top: 80px;">
  <h2 style="color:#777; font-family: calibri;">1) What work do you require?</h2><br>
    ...
    <input type="text" name="pNmae" placeholder="What is the project title?" id="text"/>
    <h4 style="color:#444; font-family:calibri;">Enter some skills that relate to the project:</h4>
    <input type="text" name="skills" placeholder="Required projects skills?" id="text"/>
     <h4 style="color:#444; font-family:calibri;">Describe your project in details:</h4>
   <textarea id="project-description" class="project-description" resize="vertical" name="pDetails" rows="3" placeholder="Describe your project here..."></textarea>
   ...
   <select id="select" name="budget">
    ...
    <input type="submit" value="Post Project" id= "post2"/>
    </div>
    </form>
